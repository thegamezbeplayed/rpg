...
ability_t ABILITIES[ABILITY_DONE]={
  ...
  {ABILITY_MAGIC_MISSLE ,DMG_FORCE, STAT_ENERGY, DES_SELECT_TARGET, 20,4,99,1,4,1,3,STAT_HEALTH, ATTR_NONE, ATTR_NONE,ABILITY_NONE},
...
category_stats_t CATEGORY_STATS[MOB_DONE] = {
  {MOB_HUMANOID, 
    {[STAT_HEALTH]=4, [STAT_REACH]=1,[STAT_ARMOR]=0,[STAT_AGGRO]=4,[STAT_ACTIONS]= 1,[STAT_STAMINA]=4, [STAT_STAMINA_REGEN_RATE]=8,[STAT_ENERGY_REGEN_RATE]=8},
    {[ATTR_CON]= 4, [ATTR_STR]=3, [ATTR_DEX]=3, [ATTR_INT]=4,[ATTR_WIS]=3,[ATTR_CHAR]=3}
  },
  {MOB_MONSTROUS,     
    {[STAT_HEALTH]=6, [STAT_REACH]=1,[STAT_AGGRO]=4,[STAT_ACTIONS]= 1},
    {[ATTR_CON]= 5, [ATTR_STR]=5, [ATTR_DEX]=4, [ATTR_INT]=3,[ATTR_WIS]=2,[ATTR_CHAR]=2}
  },
  {MOB_BEAST,
    {[STAT_REACH]=1,[STAT_HEALTH]=4, [STAT_AGGRO]=5,[STAT_ACTIONS]= 1,[STAT_STAMINA]=10},
    {[ATTR_CON]= 4, [ATTR_STR]=4, [ATTR_DEX]=5, [ATTR_INT]=3,[ATTR_WIS]=1,[ATTR_CHAR]=1}
  },
  {MOB_UNDEAD, 
    {[STAT_REACH]=1,[STAT_HEALTH]=4, [STAT_AGGRO]=3,[STAT_ACTIONS]= 1,[STAT_STAMINA]=20},
    {[ATTR_CON]= 4, [ATTR_STR]=5, [ATTR_DEX]=3, [ATTR_INT]=2,[ATTR_WIS]=1,[ATTR_CHAR]=1}
  },
  {MOB_CONSTRUCT, 
    {[STAT_REACH]=1,[STAT_HEALTH]=4, [STAT_AGGRO]=4,[STAT_ACTIONS]= 1, [STAT_STAMINA]=25},
    {[ATTR_CON]= 4, [ATTR_STR]=5, [ATTR_DEX]=4, [ATTR_INT]=0,[ATTR_WIS]=0,[ATTR_CHAR]=0}
  },
  {MOB_DEMONIC, 
    {[STAT_REACH]=1,[STAT_HEALTH]=4, [STAT_AGGRO]=4,[STAT_ACTIONS]= 1},
    {[ATTR_CON]= 4, [ATTR_STR]=4, [ATTR_DEX]=3, [ATTR_INT]=3,[ATTR_WIS]=3,[ATTR_CHAR]=4}
  },
  {MOB_FEY, 
    {[STAT_REACH]=1,[STAT_HEALTH]=4, [STAT_AGGRO]=6,[STAT_ACTIONS]= 1},
    {[ATTR_CON]= 3, [ATTR_STR]=4, [ATTR_DEX]=5, [ATTR_INT]=3,[ATTR_WIS]=4,[ATTR_CHAR]=3},
    TRAIT_MAGIC_RESIST|TRAIT_PSYCHIC_RESIST,
  },
  {MOB_CIVILIAN, 
    {[STAT_REACH]=1,[STAT_HEALTH]=3, [STAT_AGGRO]=2,[STAT_ACTIONS]= 1},
...
weapon_def_t WEAPON_TEMPLATES[WEAP_DONE]= {
  {WEAP_NONE},
  {WEAP_MACE,5,1,1,8,DMG_BLUNT,{[STAT_DAMAGE]=8,[STAT_REACH]=1,[STAT_STAMINA]=1},{},ABILITY_MELEE_BLUGDEON,TRAIT_EXP_MACE},
  {WEAP_SWORD,10,1,1,6,DMG_SLASH,{},ABILITY_MELEE_CHOP, TRAIT_EXP_SWORD},
  {WEAP_AXE,7,1,1,8,DMG_SLASH,{[STAT_DAMAGE]=8,[STAT_REACH]=1,[STAT_STAMINA]=1},{},ABILITY_MELEE_CHOP, TRAIT_EXP_AXE},
  {WEAP_DAGGER, 2, 1, 1,4,DMG_PIERCE,{[STAT_DAMAGE]=8,[STAT_REACH]=1,[STAT_STAMINA]=1,ABILITY_MELEE_STAB,TRAIT_EXP_DAGGER}
  },
  {WEAP_BOW,25,2,1,6,DMG_PIERCE,
    {[STAT_DAMAGE]=8,[STAT_REACH]=4,[STAT_STAMINA]=1},
    {[PROP_AMMO]=true,[PROP_TWO_HANDED]=true},
  ABILITY_RANGED_LOOSE, TRAIT_EXP_BOW},
};
