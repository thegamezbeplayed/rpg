...
ability_t ABILITIES[ABILITY_DONE]={
  ...
  {ABILITY_POISON_SPRAY, DMG_POISON, STAT_ENERGY, DES_SELECT_TARGET, 12, 8, 0, 1,12,0,3, STAT_HEALTH, ATTR_CON, ATTR_NONE},
...
category_stats_t CATEGORY_STATS[MOB_DONE] = {
  {MOB_HUMANOID, 
    {[STAT_HEALTH]=8, [STAT_REACH]=1,[STAT_ARMOR]=0,[STAT_AGGRO]=4,[STAT_ACTIONS]= 1,[STAT_STAMINA]=4, [STAT_STAMINA_REGEN_RATE]=8,[STAT_ENERGY_REGEN_RATE]=8},
