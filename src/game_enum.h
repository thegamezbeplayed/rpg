...
typedef enum{
  AFFECT_NONE       = -1,
  AFFECT_SAP        = BIT64(0),
  AFFECT_CHILL      = BIT64(1),
  AFFECT_BOOM       = BIT64(2),
  AFFECT_NECRO      = BIT64(3),
}AffectID;
...
typedef enum{
  ...
  SCREEN_EVENT_SELECT,
  SCREEN_EVENTS_DONE,
  SCREEN_EVENT_ACTIVATE_SEL,
  SCREEN_EVENT_SEL_END,
  EVENT_GAME_PROCESS,
  EVENT_PROCESS_READY,
  EVENT_PLAYER_INPUT,
  EVENT_INTERACTION,
