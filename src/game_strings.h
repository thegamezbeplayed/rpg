...
static ability_strings_d ABILITY_STRINGS[ABILITY_DONE] = {
  ...
  [ABILITY_ELD_BLAST]  = {ABILITY_ELD_BLAST, {"blasted {TOKE_DES} energy at", "blasts a wave of {TOKE_DESC} energy at"},"Eldritch Blast"},
  ...
  [ABILITY_CONE_COLD]    = {ABILITY_CONE_COLD, "chilled", "chills", "Cone of Cold"},
  [ABILITY_FROST_BITE]    = {ABILITY_FROST_BITE, "chilled", "chills", "Frost Bite"},
  [ABILITY_DISS_WHISP]  = {ABILITY_DISS_WHISP, "did stuff", "does stuffs", "Dissonant Whispers"},
