...
static stat_relate_t STAT_RELATION[STAT_ENT_DONE] = {
  ...
  [STAT_STAMINA_REGEN] = {STAT_STAMINA_REGEN, STAT_STAMINA, N_NONE},
  [STAT_ENERGY_REGEN] = {STAT_ENERGY_REGEN, STAT_ENERGY, N_NONE},
  [STAT_HEALTH_REGEN] = {STAT_HEALTH_REGEN, STAT_HEALTH, N_NONE},
  [STAT_STAMINA_REGEN_RATE] = {STAT_STAMINA_REGEN_RATE, STAT_STAMINA_REGEN,N_NONE},
  [STAT_ENERGY_REGEN_RATE] = {STAT_ENERGY_REGEN_RATE, STAT_ENERGY_REGEN, N_NONE},
  [STAT_HEALTH_REGEN_RATE] = {STAT_HEALTH_REGEN_RATE, STAT_HEALTH_REGEN, N_NONE},
};
...
static define_skill_rank_t SKILL_RANKS[SR_DONE] = {
  [SR_NONE]      = { SR_NONE,      0,  0, .name = "Untrained" },
  [SR_NOVICE]    = { SR_NOVICE,    3,  5, .name = "Novice"  },
  [SR_SKILLED]   = { SR_SKILLED,   6,  10, MOD_CBRT, "Skilled" },
  [SR_PROFIC]    = { SR_PROFIC,    10, 25, MOD_SQRT, "Proficient" },
  [SR_ADEPT]     = { SR_ADEPT,     15, 50, .name = "Adept"},
  [SR_EXPERT]    = { SR_EXPERT,    30, 75, .name = "Expert"},
  [SR_ACCOMP]    = { SR_ACCOMP,    45, 100,.name = "Accomplished"},
  [SR_GREAT]     = { SR_GREAT,     60, 125,.name = "Renowned"},
  [SR_ARTIS]     = { SR_ARTIS,     75, 150,.name = "Artisan"},
  [SR_MASTER]    = { SR_MASTER,    90, 200,.name = "Master" },
  [SR_MASTER_H]  = { SR_MASTER_H,  95, 400,.name = "High Master" },
  [SR_MASTER_G]  = { SR_MASTER_G,  97, 600,.name = "Grand Master" },
  [SR_LEGEND]    = { SR_LEGEND,    99, 800,.name = "Legendary" },
}; 

static skill_proficiency_bonus_t GRANTS_PB[SKILL_DONE] = {
  [SKILL_NONE]          =  {-1, -1,},           
  [SKILL_LVL]           =  {-1, -1},            
  [SKILL_ACRO]          =  {SKILL_ACRO, SKILL_CAT_ADVENTURE},           
  [SKILL_ALCH]          =  {SKILL_ALCH, SKILL_CAT_CRAFT,},           
  [SKILL_ANIM]          =  {SKILL_ANIM, SKILL_CAT_ADVENTURE,},           
  [SKILL_ARCANA]        =  {SKILL_ARCANA, SKILL_CAT_SPELL,},         

  [SKILL_ARMOR_NATURAL] =  {SKILL_ARMOR_NATURAL, SKILL_CAT_ARMOR,},  
  [SKILL_ARMOR_CLOTH] =  {SKILL_ARMOR_CLOTH, SKILL_CAT_ARMOR,},  
  [SKILL_ARMOR_PADDED]  =  {SKILL_ARMOR_PADDED, SKILL_CAT_ARMOR,},   
  [SKILL_ARMOR_LEATHER] =  {SKILL_ARMOR_LEATHER, SKILL_CAT_ARMOR,},  
  [SKILL_ARMOR_CHAIN]   =  {SKILL_ARMOR_CHAIN, SKILL_CAT_ARMOR,},    
  [SKILL_ARMOR_PLATE]   =  {SKILL_ARMOR_PLATE, SKILL_CAT_ARMOR,},    
  [SKILL_ARMOR_SHIELD]  =  {SKILL_ARMOR_SHIELD, SKILL_CAT_ARMOR,},   

  [SKILL_ATH]           =  {SKILL_ATH, SKILL_CAT_ADVENTURE},            
  [SKILL_CALL]          =  {SKILL_CALL, SKILL_CAT_CRAFT},           
  [SKILL_CARP]          =  {SKILL_CARP, SKILL_CAT_CRAFT,},           
  [SKILL_CART]          =  {SKILL_CART, SKILL_CAT_CRAFT,},           
  [SKILL_COBB]          =  {SKILL_COBB, SKILL_CAT_CRAFT,},           
  [SKILL_COOK]          =  {SKILL_COOK, SKILL_CAT_ADVENTURE},           

  [SKILL_DECEPT]        =  {SKILL_DECEPT, SKILL_CAT_SOCIAL,},         
  [SKILL_DUEL]          =  {SKILL_DUEL, SKILL_CAT_COMBAT,},         
  [SKILL_GLASS]         =  {SKILL_GLASS, SKILL_CAT_CRAFT,},          
  [SKILL_HIST]          =  {SKILL_HIST, SKILL_CAT_EDU,},           
  [SKILL_HERB]          =  {SKILL_HERB, SKILL_CAT_GATHER},           
  [SKILL_INSIGHT]       =  {SKILL_INSIGHT, SKILL_CAT_SOCIAL,},        
  [SKILL_INTIM]         =  {SKILL_INTIM, SKILL_CAT_SOCIAL,},          
  [SKILL_INVEST]        =  {SKILL_INVEST, SKILL_CAT_EDU,},         
  [SKILL_JEWL]          =  {SKILL_JEWL, SKILL_CAT_CRAFT,},           
  [SKILL_LING]          =  {SKILL_LING, SKILL_CAT_EDU,},             
  [SKILL_LW]            =  {SKILL_LW, SKILL_CAT_CRAFT,},             

  [SKILL_MASON]         =  {SKILL_MASON, SKILL_CAT_CRAFT,},          
  [SKILL_MED]           =  {SKILL_MED, SKILL_CAT_ADVENTURE},            
  ...
  [SKILL_PERFORM]       =  {SKILL_PERFORM, SKILL_CAT_SOCIAL,},        
  [SKILL_PERSUAD]       =  {SKILL_PERSUAD, SKILL_CAT_SOCIAL,},        
  ...
  [SKILL_SPELL_CONJ]    =  {SKILL_SPELL_CONJ, SKILL_CAT_SPELL,},     
  [SKILL_SPELL_DIV]     =  {SKILL_SPELL_DIV, SKILL_CAT_SPELL,},      
  [SKILL_SPELL_ENCH]    =  {SKILL_SPELL_ENCH, SKILL_CAT_SPELL,},     
  [SKILL_SPELL_EVO]     =  {SKILL_SPELL_EVO, SKILL_CAT_SPELL,},      
  [SKILL_SPELL_ILL]     =  {SKILL_SPELL_ILL, SKILL_CAT_SPELL,},      
  [SKILL_SPELL_NECRO]   =  {SKILL_SPELL_NECRO,  SKILL_CAT_SPELL,},    
  [SKILL_SPELL_TRANS]   =  {SKILL_SPELL_TRANS, SKILL_CAT_SPELL,},    

  [SKILL_STEALTH]       =  {SKILL_STEALTH, SKILL_CAT_ADVENTURE,
    SKILL_PERCEPT,
    4,
    ATTR_DEX,
    PC_SAVE
  ...
  [SKILL_WEAV]          =  {SKILL_WEAV, SKILL_CAT_CRAFT},           

  [SKILL_WEAP_SIMP]     =  {SKILL_WEAP_SIMP, SKILL_CAT_COMBAT,},      
  [SKILL_WEAP_MART]     =  {SKILL_WEAP_MART, SKILL_CAT_COMBAT,},      
  [SKILL_WEAP_MACE]     =  {SKILL_WEAP_MACE, SKILL_CAT_COMBAT,},      
  [SKILL_WEAP_SHOT]     =  {SKILL_WEAP_SHOT, SKILL_CAT_COMBAT,},      
  [SKILL_WEAP_SWORD]    =  {SKILL_WEAP_SWORD, SKILL_CAT_COMBAT,},     
  [SKILL_WEAP_AXE]      =  {SKILL_WEAP_AXE, SKILL_CAT_COMBAT,},       
  [SKILL_WEAP_DAGGER]   =  {SKILL_WEAP_DAGGER, SKILL_CAT_COMBAT,},    
  [SKILL_WEAP_BOW]      =  {SKILL_WEAP_BOW, SKILL_CAT_COMBAT,},       
  [SKILL_WEAP_PICK]     =  {SKILL_WEAP_PICK, SKILL_CAT_COMBAT,},      
  [SKILL_WEAP_STAFF]    =  {SKILL_WEAP_STAFF, SKILL_CAT_COMBAT,},     
  [SKILL_WEAP_SPEAR]    =  {SKILL_WEAP_SPEAR, SKILL_CAT_COMBAT,},     
  [SKILL_WEAP_WHIP]     =  {SKILL_WEAP_WHIP, SKILL_CAT_COMBAT,},      
