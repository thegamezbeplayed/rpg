...
static map_gen_t MAPS[MAP_DONE]= {
  ...
  {DANK_DUNGEON, MAPFLAG_DUNGEON, 2,20,6,
    .mobs={
      MOB_LOC_DUNGEON |
    ...
    2,1,
    {
      ...
      {
        34,39,12,
        ROOM_LAYOUT_HALL | ROOM_SIZE_MASSIVE | ROOM_PURPOSE_CONNECT | ROOM_SHAPE_SQUARE | ROOM_ORIENT_VER | ROOM_PLACING_S
      },
      {
        42, 10,11,
        ROOM_SIZE_MASSIVE | ROOM_LAYOUT_OPEN | ROOM_PURPOSE_LAIR | ROOM_SHAPE_SQUARE | ROOM_PLACING_N
      },
      {
        30,20,10,
        ROOM_LAYOUT_HALL | ROOM_SIZE_MASSIVE | ROOM_PURPOSE_CONNECT | ROOM_SHAPE_SQUARE | ROOM_PLACING_N | ROOM_ORIENT_VER,
      },
      {
       12, 44,10,
       ROOM_LAYOUT_OPEN | ROOM_SIZE_XL | ROOM_PURPOSE_CHALLENGE | ROOM_SHAPE_RECT | ROOM_PLACING_S | ROOM_ORIENT_VER
      }
    },
    MN_GRID,
  }
...
static map_node_data_t room_nodes[MAP_NODE_DONE] = {
  {MN_GRID, MAP_NODE_ROOT,NULL,6,{MN_GENERATE_ROOMS,MN_GRAPH_ROOTS,MN_CLEANUP,MN_GRID_GEN,MN_BUILD, MN_CHECK_MAP}},
  {MN_SELECT_ROOMS, MAP_NODE_SEQUENCE,NULL,1,{MN_GENERATE_ROOMS }},
  ...
  {MN_CHECK_MAP, MAP_NODE_SEQUENCE, NULL, 2,{MN_PATHS, MN_ISSUES,}},
