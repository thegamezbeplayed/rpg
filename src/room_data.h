...
static const ObjectInstance room_instances[ENT_DONE] = {
  {ENT_PERSON,SIZE_MEDIUM,"Frank the Tank",1,1,1,100,SPAWN_SOLO,{GEAR_MACE, GEAR_BOW_LIGHT, GEAR_LEATHER_ARMOR},{ABILITY_MAGIC_MISSLE, ABILITY_DONE}},
...
static const map_gen_t MAPS[MAP_DONE]= {
  ...
  {DANK_DUNGEON, MAPFLAG_DUNGEON, 2, 4, 4,
    {
