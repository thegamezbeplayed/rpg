...
static const ItemInstance room_items[GEAR_DONE] = {
  ...
  {GEAR_LEATHER_ARMOR,ITEM_ARMOR,ARMOR_LEATHER,PROP_QUAL_POOR, PROP_WEAP_SIMP, BROWN},
  ...
  {GEAR_BANDOLIER, ITEM_CONTAINER, INV_SLING, PROP_QUAL_FINE | PROP_MAT_LEATHER, PROP_CONT_PHIAL, BROWN, ICON_BAND}
};
