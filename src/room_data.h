...
static map_gen_t MAPS[MAP_DONE]= {
  ...
  {DANK_DUNGEON, MAPFLAG_DUNGEON, 20,24,1,2,
    .mobs={
      MOB_LOC_DUNGEON |
    ...
    },
    {
      ...
      {
        2,8, ROOM_LAYOUT_HALL | ROOM_SIZE_MASSIVE | ROOM_PURPOSE_CONNECT | ROOM_SHAPE_SQUARE | ROOM_ORIENT_HOR | ROOM_PLACING_E
      },
      {
        7,11, ROOM_LAYOUT_HALL | ROOM_SIZE_MASSIVE | ROOM_PURPOSE_CONNECT | ROOM_SHAPE_SQUARE | ROOM_ORIENT_VER | ROOM_PLACING_S
      }
    },
    MN_OPT,
  }
...
static map_node_data_t room_nodes[MAP_NODE_DONE] = {
  {MN_GRID, MAP_NODE_ROOT,NULL,4,{MN_SELECT_ROOMS, MN_GRID_GEN, MN_BUILD, MN_DETAIL}},
  ...
  {MN_OPT, MAP_NODE_ROOT, NULL, 3, {MN_OPT_INIT,MN_GENERATE_ROOMS,MN_SCAN, }},
