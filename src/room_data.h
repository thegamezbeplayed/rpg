...
static const BehaviorData room_behaviors[ BN_COUNT] = {
  ...
  {BN_AGGRO, true, BT_SEQUENCE, NULL, true, STATE_IDLE, 2, 
    {BN_AGGRO_DEC, BN_DEC}},
  {BN_AGGRO_DEC, false, BT_LEAF, LeafCheckAggro},
  {BN_PRIO, false, BT_SEQUENCE, NULL, false, 0, 3,
    {BN_PRIO_DEC, BN_DEC, BN_CHANGE_STATE}},
  {BN_PRIO_DEC, false, BT_LEAF, LeafGetPriority},
  {BN_NEED, true, BT_SEQUENCE, NULL, true, STATE_STANDBY, 2,
    {BN_NEED_DEC, BN_DEC}},
  {BN_NEED_DEC, false, BT_LEAF, LeafFillNeed},
