...
static const BehaviorData room_behaviors[ BEHAVIOR_COUNT] = {
  ...
  { BEHAVIOR_CHECK_AGGRO,false,BT_SELECTOR, NULL,true, STATE_IDLE,4,{BEHAVIOR_CHECK_ENEMIES, BEHAVIOR_FIND_ENEMY, BEHAVIOR_GET_TARGET, BEHAVIOR_CHANGE_STATE}},
  ...
  {BEHAVIOR_AGGRO_TABLE, false, BT_LEAF, LeafCheckAggro, false},
  {BEHAVIOR_CHECK_SENSE, false, BT_LEAF, LeafCheckSenses, false},
  {BEHAVIOR_CHECK_ENEMIES, false, BT_SELECTOR, NULL, false, 0, 2, {BEHAVIOR_GET_AGGRO, BEHAVIOR_FIND_ENEMY}},
  {BEHAVIOR_GET_AGGRO, false, BT_SEQUENCE, NULL, true, STATE_AGGRO, 2, {BEHAVIOR_AGGRO_TABLE, BEHAVIOR_CHANGE_STATE}},
  {BEHAVIOR_FIND_ENEMY, false, BT_SEQUENCE, NULL, true, STATE_AGGRO, 2, {BEHAVIOR_CHECK_SENSE, BEHAVIOR_CHANGE_STATE}},
  {BEHAVIOR_SPAWN, true, BT_SEQUENCE,  NULL, false, 0, 3, {BEHAVIOR_BUILD_ALLIES, BEHAVIOR_PREPARE_GEAR, BEHAVIOR_PREPARE_ABILITIES,}},
  {BEHAVIOR_BUILD_ALLIES, false, BT_LEAF, LeafBuildAllyTable},
  {BEHAVIOR_PREPARE_GEAR, false, BT_LEAF, LeafCheckInventory},
  {BEHAVIOR_PREPARE_ABILITIES, false, BT_LEAF, LeafCheckAbilities},
};
#endif
