...
static const map_gen_t MAPS[MAP_DONE]= {
  ...
  {DANK_DUNGEON, MAPFLAG_DUNGEON, 2, 4,2+MAX_ROOM_SIZE, 2,4,3,
    {
    ...
    },
    {
      ...
      {
        {CONF_START},{CONF_FLAG, ROOM_SIZE_HUGE},{CONF_FLAG, ROOM_LAYOUT_ROOM},{CONF_FLAG, ROOM_PURPOSE_CHALLENGE},{CONF_FLAG, ROOM_SHAPE_SQUARE},{CONF_END},
      },
      {    
      {CONF_START},{CONF_FLAG, ROOM_SIZE_MASSIVE},{CONF_FLAG, ROOM_LAYOUT_ROOM},{CONF_FLAG, ROOM_PURPOSE_CHALLENGE},{CONF_FLAG, ROOM_SHAPE_SQUARE},{CONF_END},
      }
