...
static const map_gen_t MAPS[MAP_DONE]= {
  ...
  {DANK_DUNGEON, MAPFLAG_DUNGEON, 2, 2,4,9,3,
    {
    ...
    },
    {
      ROOM_SIZE_LARGE | ROOM_LAYOUT_ROOM | ROOM_PLACING_E | ROOM_PURPOSE_START | ROOM_SHAPE_SQUARE,
       ...
       ROOM_LAYOUT_NONE | ROOM_PLACING_N,
       ROOM_LAYOUT_NONE | ROOM_PLACING_N,
       ROOM_LAYOUT_NONE | ROOM_PLACING_N,
       ROOM_LAYOUT_NONE | ROOM_PLACING_S,
       ROOM_LAYOUT_NONE | ROOM_PLACING_S,
       ROOM_LAYOUT_NONE | ROOM_PLACING_S,
       ROOM_LAYOUT_ROOM | ROOM_PLACING_E | ROOM_SIZE_LARGE | ROOM_SHAPE_CIRCLE
    },
    MN_GRID,
  }
};
...
static map_node_data_t room_nodes[MAP_NODE_DONE] = {
  ...
  {MN_GRID_GEN, MAP_NODE_SEQUENCE, NULL,6,{MN_MAP_OUT_GRID,  MN_APPLY_SHAPES, MN_PLACE_ROOMS,MN_COMPUTE_BOUNDS, MN_ALLOCATE_TILES,MN_CARVE_TILES  }},
