...
static map_gen_t MAPS[MAP_DONE]= {
  ...
  {DANK_DUNGEON, MAPFLAG_DUNGEON, 2,4,9,3,
    {
      MOB_LOC_DUNGEON |
    ...
    },
    {
      ...
      ROOM_LAYOUT_NONE | ROOM_PLACING_N | ROOM_PURPOSE_LAIR, 
      ROOM_LAYOUT_NONE | ROOM_PLACING_N | ROOM_PURPOSE_LAIR,
      ROOM_LAYOUT_NONE | ROOM_PLACING_N | ROOM_PURPOSE_LAIR, 
      ROOM_LAYOUT_NONE | ROOM_PLACING_S | ROOM_PURPOSE_LAIR,
      ROOM_LAYOUT_NONE | ROOM_PLACING_S | ROOM_PURPOSE_LAIR,
      ROOM_LAYOUT_NONE | ROOM_PLACING_S | ROOM_PURPOSE_LAIR,
      ROOM_LAYOUT_ROOM | ROOM_PLACING_E | ROOM_SIZE_LARGE | ROOM_SHAPE_CIRCLE | ROOM_PURPOSE_CHALLENGE | ROOM_PURPOSE_LAIR
    },
    MN_GRID,
  }
};
