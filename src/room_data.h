...
static const ItemInstance room_items[GEAR_DONE] = {
  {GEAR_MACE, ITEM_WEAPON, WEAP_MACE,PROP_QUAL_TRASH},
  {GEAR_LEATHER_ARMOR,ITEM_ARMOR,ARMOR_LEATHER,PROP_QUAL_STANDARD},
  {GEAR_LEATHER_CAP, ITEM_ARMOR,ARMOR_LEATHER,PROP_QUAL_STANDARD},
  {GEAR_CLUB, ITEM_WEAPON, WEAP_MACE,PROP_QUAL_TRASH},
  {GEAR_HAND_AXE, ITEM_WEAPON, WEAP_AXE,PROP_QUAL_TRASH},
  {GEAR_CLOTH_ARMOR,ITEM_ARMOR,ARMOR_PADDED,PROP_QUAL_TRASH},
  {GEAR_DAGGER, ITEM_WEAPON, WEAP_DAGGER,PROP_QUAL_TRASH},
  {GEAR_BOW_LIGHT,ITEM_WEAPON, WEAP_BOW,PROP_QUAL_STANDARD},
