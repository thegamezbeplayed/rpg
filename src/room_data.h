  ...
  {DANK_DUNGEON, MAPFLAG_DUNGEON, 2, 4,2+MAX_ROOM_SIZE, 2,11,3,
    {
      ...
      {ENT_RAT, SPAWN_SWARM,22},
      {ENT_DONE}
    },
    {
      {
        {CONF_START},{CONF_FLAG, ROOM_SIZE_LARGE},{CONF_FLAG, ROOM_LAYOUT_ROOM},{CONF_FLAG, ROOM_PURPOSE_START},{CONF_FLAG, ROOM_SHAPE_SQUARE},{CONF_END}
      },
      {
        {CONF_START},{CONF_FLAG, ROOM_LAYOUT_HALL},{CONF_FLAG,ROOM_SIZE_MASSIVE},{CONF_FLAG,ROOM_PURPOSE_CONNECT},{CONF_END}
      },
      {{CONF_FLAG, ROOM_LAYOUT_HALL}},
      {{CONF_FLAG, ROOM_LAYOUT_HALL}},
      {{CONF_FLAG, ROOM_LAYOUT_HALL}},
      {{CONF_FLAG, ROOM_LAYOUT_HALL}},
      {{CONF_FLAG, ROOM_LAYOUT_HALL}},
...
static map_node_data_t room_nodes[MAP_NODE_DONE] = {
  {MN_GRID, MAP_NODE_ROOT,NULL,2,{MN_SELECT_ROOMS, MN_GRID_GEN}},
  {MN_SELECT_ROOMS, MAP_NODE_SEQUENCE,NULL,2,{MN_FILL_MISSING_ROOMS, MN_GENERATE_ROOMS,}},
  {MN_FILL_MISSING_ROOMS, MAP_NODE_LEAF,LeafMapFillMissing,0},
  {MN_GENERATE_ROOMS, MAP_NODE_LEAF, LeafMapGenerateRooms ,0},
  {MN_GRID_GEN, MAP_NODE_SEQUENCE, NULL,6,{MN_MAP_OUT_GRID,MN_PLACE_ROOMS, MN_COMPUTE_BOUNDS,MN_PLACE_ROOMS,MN_ALLOCATE_TILES,MN_CARVE_TILES  }},
  {MN_MAP_OUT_GRID, MAP_NODE_LEAF, LeafMapGridLayout ,0},
  {MN_PLACE_ROOMS, MAP_NODE_LEAF, LeafMapAssignPositions,0}, 
