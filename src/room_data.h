...
static map_gen_t MAPS[MAP_DONE]= {
  {DARK_FOREST, "Dark Forest", BIO_FOREST, 1.5, 2.25f,
    MAPFLAG_FOREST, 1, 3, 16, TILEFLAG_FLOOR, ENV_FOREST_EXIT,
    .mobs = {
  ...
  {DANK_DUNGEON, "Abandoned Dungeon", BIO_DUNGEON, 0.75,2.0f,
    MAPFLAG_DUNGEON, 2,20,36, TILEFLAG_DOOR, ENV_EXIT,
    .mobs={
      MOB_LOC_DUNGEON |
        MOB_FREQ_COMMON |
...
static map_node_data_t room_nodes[MAP_NODE_DONE] = {
  ...
  {MN_DETAIL, MAP_NODE_SEQUENCE, NULL, 6,{MN_ECO, MN_ENCASE_FLOORS, MN_DECOR, MN_PLACE_POI,MN_ENH, MN_SET_PLAYER}},
  ...
  {MN_DECOR, MAP_NODE_LEAF, LeafMapDecor, 0}
};
...
static const BehaviorData room_behaviors[ BN_COUNT] = {
  ...
  {BN_AGGRO, true, BT_SELECTOR, NULL, true, STATE_IDLE, 3, 
    {BN_AGGRO_DEC, BN_WANDER, BN_CHANGE_STATE}},
  {BN_AGGRO_DEC, false, BT_SEQUENCE, NULL, false, STATE_NONE, 3,
   {BN_GET_AGGRO, BN_CHECK_ABILITY, BN_DEC}},
  ...
  {BN_GET_AGGRO, false, BT_LEAF, LeafCheckAggro}
};
#endif
